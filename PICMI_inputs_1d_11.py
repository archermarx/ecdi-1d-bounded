...
L = 0.5e-2         # Simulation domain length (m)
L_axial = 1e-2     # Virtual axial length
max_time = 5e-6    # Max time (s)
...
diag_name = "subcycle_11"  # Diagnostic output folder
...
ions = picmi.Species(
    particle_type = species, name = 'ions', mass = m_i, charge = 'q_e', warpx_do_subcycling = True, warpx_subcycling_interval = 11
)
